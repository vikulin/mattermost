...
import {SystemConsolePage, duration, expect, test} from '@mattermost/playwright-lib';
...
test.describe('LDAP filter and admin login behavior', () => {
    ...
    test('MM-T2821 LDAP Admin Filter', {tag: '@ldap'}, async ({pw}) => {
        ...
        const consolePage = new SystemConsolePage(pw.loginPage.page);
        await consolePage.goto();
        await consolePage.toBeVisible();
    });

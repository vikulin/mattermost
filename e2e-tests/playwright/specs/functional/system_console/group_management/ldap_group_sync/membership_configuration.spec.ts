...
test.describe('LDAP group membership and configuration', () => {
    ...
    test('MM-T1537 - Sync Group Removal from Channel Configuration Page', {tag: '@ldap'}, async ({pw}) => {
        ...
        await consolePage.channelConfiguration.expectGroupVisible('board');
        await consolePage.channelConfiguration.removeFirstGroup();
        ...
        await consolePage.channelConfiguration.expectGroupVisible('developers');
        await consolePage.channelConfiguration.expectGroupNotVisible('board');
    });
    ...
    test(
        ...
        async ({pw}) => {
            ...
            await consolePage.managementLists.gotoGroups();
            await consolePage.managementLists.openFirstResult();
            ...
            await consolePage.groupConfiguration.expectTeamRemovalWarning(team.display_name);

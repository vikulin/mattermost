...
// TestMigration000205 verifies the split of AttributeView into per-object-type
...
func TestMigration000205(t *testing.T) {
	...
	// New() applies all migrations, so 000205 is already in effect.
	...
	downSQL := readMigrationSQL(t, "000205_split_attribute_view_by_object_type.down.sql")
	upSQL := readMigrationSQL(t, "000205_split_attribute_view_by_object_type.up.sql")

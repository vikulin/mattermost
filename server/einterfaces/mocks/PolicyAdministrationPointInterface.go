...
func (_m *PolicyAdministrationPointInterface) HasActiveAllChannelsPolicy(rctx request.CTX) bool {
	ret := _m.Called(rctx)
...
func (_m *PolicyAdministrationPointInterface) InvalidateAllChannelsCache(rctx request.CTX) {
	_m.Called(rctx)
}

...
// object_type values on the autocomplete PropertyFields. Custom profile
// attributes and native user attributes both target the `user` object type;
// channel fields back resource.attributes.* references in ABAC policies;
// session attributes are the exception (`session`).
